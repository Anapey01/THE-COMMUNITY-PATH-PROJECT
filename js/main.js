...
        if (appContainer) appContainer.innerHTML = "<p class='text-red-500'>Error: Session could not be loaded.</p>";
        return;
    }
    
...
/**
 * [NEW] A dedicated function to trigger the validation summary
 */
...
/**
 * [RE-WRITTEN] Handles user chat submissions.
 */
