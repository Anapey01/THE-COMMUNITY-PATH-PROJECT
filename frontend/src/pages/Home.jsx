  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-sans">
      ...
      <main>
        ...
        {/* --- 2. THE CHALLENGE SECTION (With dots.jpg) --- */}
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                        We map every academic path to these goals, ensuring that your future career contributes to solving global issues like poverty, education, and climate change.
                    </p>
